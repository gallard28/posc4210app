    ...
    <h1>Choose Analytical Tools</h1>
      ...
      <div class="section">
        <div class="row">
          ...
          <br>
          <h3>Instructions </h3>
          <p class="left-align">Your group has a budget of 230,000 resource units (RUs). Resource units are a indexed measurement of time and money. Your group must now choose which analytical tools to use for each hypothesis. Each analytical tool costs a different amount of RUs (see below for prices). For example, heuristic-based techniques are less expensive (but also less accurate) than statistically/scientifically-based techniques. 
            <br> <br> 
