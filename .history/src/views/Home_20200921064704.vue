          ...
          <div class="card teal darken-2">
            <div class="card-content">
              <p class="left-align white-text">
                <ol>
                  <li>Log into your g.clemson.edu account and access the following link <a href="https://docs.google.com/document/d/16TZA8md0masyjI_Gi1CXw8bq0G-gOx4zrA84iQO_Zkk/edit?usp=sharing">add google docs link</a>. </li>
